...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and snailcoin: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a snailcoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Snailcoin command-line options").arg(PACKAGE_NAME));
